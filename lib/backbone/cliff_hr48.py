...
from lib.backbone.hrnet.cls_hrnet import HighResolutionNet
from lib.backbone.hrnet.hrnet_config import cfg
from lib.backbone.hrnet.hrnet_config import update_config
...
class CLIFF(nn.Module):
    ...
    def __init__(self, smpl_mean_params, img_feat_num=2048):
        ...
        config_file = "/media/DATA2/wchuq/3DHPE/TCMR_RELEASE-master/lib/backbone/hrnet/models/cls_hrnet_w48_sgd_lr5e-2_wd1e-4_bs32_x100.yaml"
