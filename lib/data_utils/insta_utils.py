...
TCMR_DB_DIR = "/media/DATA2/wchuq/3DHPE/TCMR_RELEASE-master/self_preprocess_data"
...
def read_single_record(fname):
    ...
    for vid_idx, serialized_ex in tqdm(enumerate(tf.python_io.tf_record_iterator(fname))):
        ...
        features = extract_features(model,None, video, bbox=None, kp_2d=kp_2d, dataset='insta', debug=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', type=str, help='dataset directory', default="/media/DATA2/wchuq/3DHPE/dataset/insta_variety/")
